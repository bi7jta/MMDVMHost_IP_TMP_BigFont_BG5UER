...
// Add by BG5UER, 2017/12/4 14:48:23
void CDisplay::writeTimeBer(float time, float ber)
{
	writeOledTimeBer(time, ber);
}
	

void CDisplay::writeRTimeBer(float time, float loss, float ber)
{
	writeOledRTimeBer(time, loss, ber);
}

void CDisplay::writeOledRTimeBer(float time, float loss, float ber)
{
}

void CDisplay::writeOledTimeBer(float time, float ber)
{
}
