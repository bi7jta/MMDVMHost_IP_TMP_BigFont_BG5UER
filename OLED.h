...
public:
  ...
  COLED(unsigned char displayType, unsigned char displayBrighness, bool displayInvert, bool displayScroll, const std::string& callsign);
  ...
  virtual void writeOledTimeBer(float time, float ber);
  virtual void writeOledRTimeBer(float time, float loss, float ber);
