...
void Log(unsigned int level, const char* fmt, ...)
{
	...
	::sprintf(buffer, "%c: %04d-%02d-%02d %02d:%02d:%02d.%03lu ", LEVELS[level], tm->tm_year + 1900, tm->tm_mon + 1, tm->tm_mday, tm->tm_hour + tz.tz_minuteswest/60, tm->tm_min, tm->tm_sec, now.tv_usec / 1000U);
#endif
